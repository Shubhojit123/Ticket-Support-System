...
function DeletedTicketDetails() {
    ...
    const { addComment, getAllTickets, setData, isTablet } = useContext(TicketContext)
...
export default DeletedTicketDetails
